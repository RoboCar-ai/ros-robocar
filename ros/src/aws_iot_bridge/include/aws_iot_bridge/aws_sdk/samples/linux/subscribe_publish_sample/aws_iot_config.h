...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1pj26jvxq66z4-ats.iot.us-east-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_CERTIFICATE_FILENAME   "test.cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "test.private.key" ///< Device private key filename
// =================================================
